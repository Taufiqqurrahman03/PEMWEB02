...
$count_query = "SELECT COUNT(*) FROM jenis_faskes $search_condition";
...
$query = "SELECT * FROM jenis_faskes $search_condition ORDER BY nama LIMIT :start, :per_page";
    ...
    <div class="sidebar">
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" role="menu">
          ...
          <li class="nav-item"><a href="list_jenis.php" class="nav-link active"><i class="nav-icon fas fa-hospital-symbol"></i><p>Jenis Faskes</p></a></li>
  ...
  <div class="content-wrapper">
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Data Jenis Faskes</h1>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container-fluid">
        ...
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">Daftar Jenis Faskes</h3>
          ...
          <div class="card-body table-responsive p-0">
            <table class="table table-hover text-nowrap">
              ...
              <tbody>
                <?php if (count($jenis_data) > 0): ?>
                  <?php $no = $start + 1; foreach ($jenis_data as $row): ?>
                    <tr>
                      <td><?= $no++ ?></td>
