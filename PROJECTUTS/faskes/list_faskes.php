...
$search_condition = $search ? "WHERE f.nama LIKE :search" : "";

// Query untuk menghitung total data
$count_query = "SELECT COUNT(*) FROM faskes f $search_condition";
try {
    ...
    $query = "
        ...
        FROM faskes f
        LEFT JOIN jenis_faskes j ON f.jenis_id = j.id
        LEFT JOIN kabkota k ON f.kabkota_id = k.id
        LEFT JOIN provinsi p ON k.provinsi_id = p.id
        $search_condition 
        ORDER BY f.id DESC LIMIT :start, :per_page
    ";
  ...
  <div class="content-wrapper">
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Data Fasilitas Kesehatan</h1>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container-fluid">
        ...
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">Daftar Fasilitas Kesehatan</h3>
          ...
          <div class="card-body table-responsive p-0">
            <table class="table table-hover text-nowrap">
              ...
              <tbody>
                <?php if (isset($faskes_data) && count($faskes_data) > 0): ?>
                  <?php $no = $start + 1; foreach ($faskes_data as $row): ?>
                    <tr>
                      <td><?= $no++ ?></td>
                      ...
                      <td>
                        <a href="edit_faskes.php?id=<?= $row['id'] ?>" class="btn btn-warning btn-sm">
                          <i class="fas fa-edit"></i> Edit
                        </a>
                        <a href="hapus_faskes.php?id=<?= $row['id'] ?>" class="btn btn-danger btn-sm" 
          ...
          <div class="card-footer clearfix">
            <a href="tambah_faskes.php" class="btn btn-primary float-left">
