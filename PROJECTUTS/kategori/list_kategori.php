...
$count_query = "SELECT COUNT(*) FROM kategori $search_condition";
...
$query = "SELECT * FROM kategori $search_condition ORDER BY nama LIMIT :start, :per_page";
    ...
    <div class="sidebar">
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" role="menu">
          ...
          <li class="nav-item"><a href="list_kategori.php" class="nav-link active"><i class="nav-icon fas fa-tags"></i><p>Kategori</p></a></li>
            ...
            <table class="table table-hover text-nowrap">
              ...
              <tbody>
                <?php if (count($kategori_data) > 0): ?>
                  <?php $no = $start + 1; foreach ($kategori_data as $row): ?>
                    <tr>
                      <td><?= $no++ ?></td>
